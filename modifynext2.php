...
<form method = "post" action="">
  ...
  &nbsp;&nbsp;&nbsp;<b><h4 class="test1">INSERT MODIFIED DATA:<br></h4>
  &nbsp;&nbsp;&nbsp;<label for="petid"><b>ENTER THE PET ID AGAIN:</label><br>
  &nbsp;&nbsp;&nbsp;<input type="text" id="petid" name="petid" value=""><br><br>
  
  &nbsp;&nbsp;&nbsp;<label for="pettype"><b>ENTER NEW PET TYPE:</label><br>
  &nbsp;&nbsp;&nbsp;<input type="text" id="pettype" name="pettype" value=""><br><br>

  &nbsp;&nbsp;&nbsp;<label for="petbreed">ENTER NEW PET BREED:</label><br>
  &nbsp;&nbsp;&nbsp;<input type="text" id="petbreed" name="petbreed" value=""><br><br>

    &nbsp;&nbsp;&nbsp;<label for="accessory">ENTER NEW ACCESSORY:</label><br>
  &nbsp;&nbsp;&nbsp;<input type="text" id="accessory" name="accessory" value=""><br><br>

  &nbsp;&nbsp;&nbsp;<label for="foodbrand">ENTER NEW FOODBRAND:</label><br>
